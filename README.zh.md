...
- **原生 macOS，不是 Electron。** SwiftUI + SwiftData 构建。没有 web view，没有打包的浏览器。
...
从 **[hodor.design](https://hodor.design)** 或 **[GitHub Releases](https://github.com/woody-design/hodor/releases)** 下载最新 DMG。
...
所有 prompt 都存在本地，使用 SwiftData，路径是 `~/Library/Application Support/Hodor/Hodor.store`。不同步，不上传，不发送。
...
[GPL v3](LICENSE) — Designed by [Woody](https://woodydesign.io/) & [CC](https://claude.ai/) in NY
